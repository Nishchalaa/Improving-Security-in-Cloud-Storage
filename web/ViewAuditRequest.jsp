...
<body class="main-layout ">
                                    ...
                                    <div class="limit-box">
                                        <nav class="main-menu">
                                            <ul class="menu-area-main">
                                               ...
                                               <li><a href="ViewAuditRequest.jsp">View Requests</a></li>
                                              <li><a href="ViewAuditProof.jsp">View Audit Proof</a></li>
        ...
        <div class="container" style="margin-bottom:400px;">
            <div class="row">
                ...
                <div class="col-xl-7 col-lg-7 col-md-7 co-sm-l2">
                   <h2><span>View Audit Request </span></h2>
           <table border="1">
                       <tr>
                           <th>Owner</th>
                           <th>File ID</th>
    ...
    ResultSet r=st.executeQuery("select * from request where  status='waiting'");                     
       while(r.next()){
           %>
           <tr>
               ...
               <td><%=r.getString("fid")%></td>
                 <td><%=r.getString("rdate")%></td>
                       ...
                       <td><a href="AcceptAud.jsp?id=<%=r.getString("id")%>">Send Proof To Cloud</a></td>
           </tr> 
           <%
       }                   
                      }catch(Exception e){
