        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-xl-7 col-lg-7 col-md-7 co-sm-l2">
                   <h2><span>Welcome User Registration Page</span></h2>
          
       
              <form name="reg" action="UserRegAction.jsp" method="post">
              <table>
                  <tr><th>Name </th><td><input type="text" name="name" placeholder="Enter Name" required></input></td></tr>
                  <tr><th>Email </th><td><input type="text" name="Emailid" placeholder="Enter Email ID" required></input></td></tr>
                  <tr><th>DOB </th><td><input type="date" name="DateOfBirth" placeholder="Enter Date Of Birth" required></input></td></tr>
                            
                   <tr><th>Gender </th><td><input type="radio" name="gender" value="Male">Male
                       <input type="radio" name="gender" value="Female">Female
                       <input type="radio" name="gender" value="Others">Other</td></tr>
                            
                 
                
                  <tr><th>Mobile </th><td><input type="text" name="mobile" placeholder="Enter Mobile Number" required></input></td></tr>
                  <tr><th>Address </th><td><input type="text" name="address" placeholder="address" required></input></td></tr>
                 
                  <tr><th>UserName </th><td><input type="text" name="username" placeholder="Enter Username" required></input></td></tr>
              <tr><th>Password </th><td><input type="password" name="password"  placeholder="Enter Password"  required></input></td></tr>
               
              <tr><td><input type="Submit" value="Register"><input type="Reset" ></input></td></tr>
