...
<body class="main-layout ">
    ...
    ResultSet r=st.executeQuery("select * from user where emailid='"+email+"'");
    String pkey=null;
    while(r.next()){
        pkey=r.getString("pkg");
    }%>
                           
                           
                            <tr><th>Private Key</th><td><input type="text" name="pkey" value="<%=pkey%>" required=""></tD></tr>
                              <tr><th>Name:</th><td><input type="text" name="name" required=""></tD></tr>
                            <tr><th>Blood Group</th><td><input type="text" name="bgroup" required=""></tD></tr>
                            <tr><th>Blood Pressure</th><td><input type="text" name="bp" required=""></tD></tr>
                             <tr><th>Disease</th><td><input type="text" name="disease" required=""></tD></tr>
                            <tr><th>Report</th><td><input type="file" name="file" required=""></tD></tr>
