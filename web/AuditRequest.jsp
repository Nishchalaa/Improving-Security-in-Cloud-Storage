...
<body class="main-layout ">
    ...
    <div id="about" class="about">
        <div class="container" style="margin-bottom:400px;">
            <%String email=(String)session.getAttribute("email");%>
                   ...
                   <h2><span>Send Audit Request</span></h2>
                   <table border="1">
                       <tr>
                           <th>FileName</th>
                           <th>Signature</th>
    ...
    Statement st=con.createStatement();
     ResultSet r=st.executeQuery("select * from file where email='"+email+"' and status='Approved'");                     
       while(r.next()){
           %>
           <tr>
                       ...
                       <td><a href="SendAuditRequest.jsp?id=<%=r.getString("id")%>">Send Request</a></td>
           </tr> 
           <%
       }                   
                      }catch(Exception e){
