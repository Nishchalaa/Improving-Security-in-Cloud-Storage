        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-xl-7 col-lg-7 col-md-7 co-sm-l2">
                   <h2><span>Welcome User Login Page</span></h2>
          
          <div class="clr">
              <form name="login" action="UserLAction.jsp" method="post">
              <table cellpadding="10px" >
                  
                  <tr><td><font color="green">Email ID</font></td><td><input type="text" name="email" placeholder="Enter Email id" required></input></td></tr>
              ...
              <tr><th>New User?<a href="UserRegister.jsp">Register</a></th></tr>
                </table>
              </form>
                </div>
            </div>
