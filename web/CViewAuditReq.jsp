...
<body class="main-layout ">
        ...
        <div class="container" style="margin-bottom:400px;">
            <div class="row">
                ...
                <div class="col-xl-7 col-lg-7 col-md-7 co-sm-l2">
                   <h2><span>Welcome All Audit Request</span></h2>
           <table border="1">
                       <tr>
                           <th>File Id</th>
                           <th>File Owner</th>
    ...
    Statement st=con.createStatement();
     ResultSet r=st.executeQuery("select * from request where status='Approved'");                     
       while(r.next()){
           String stat=r.getString("status1");
           %>
           <tr>
               <td><%=r.getString("fid")%></td>
                 ...
                 <%if(stat.equals("waiting")){
                     %>
                    <td><a href="TAcceptData.jsp?id=<%=r.getString("id")%>">Approve</a></td> 
                     <%
                 }else{
%>
